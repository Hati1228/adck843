...
//        try {
//            gameMusic = new SoundClip("data/Level1Sound.mp3");   // Open an audio input stream
...
//        }
        ...
        background = new ImageIcon("data/City1.png").getImage();
        ...
        new Life(this).setPosition(new Vec2(20, 10f));
        ...
        //MoneyPickup
        getThief().addCollisionListener(new MoneyPickup(getThief()));
